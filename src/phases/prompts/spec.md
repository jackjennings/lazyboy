...
Make a concrete decision for each ambiguous requirement. Do not present
alternatives or options. Do not include implementation guidance, code examples,
or algorithm options — those belong in the plan phase.
